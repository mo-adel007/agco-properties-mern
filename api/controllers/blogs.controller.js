...
export const createPost = async (req, res) => {
  try {
    const { title, summary, content, cover, category, blogAuthor, isPublished } = req.body;
...
// export const searchBlogsByName = async (req, res, next) => {
//   try {
//     const { title } = req.query; // Extract the name from the query parameters
