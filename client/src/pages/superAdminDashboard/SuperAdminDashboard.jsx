...
export default function SuperAdminDashboard() {
  ...
  const handleDelete = async (id, type) => {
    try {
      ...
      toast.error("There was a problem deleting the post");
  ...
  const handlePublish = async (id, type, isPublished) => {
    try {
      ...
      toast.success(
        isPublished
          ? "The post was unpublished successfully"
          : "The post was published successfully"
      );
      setActiveTab(type);
    } catch (error) {
      toast.error("There was a problem publishing/unpublishing the post");
