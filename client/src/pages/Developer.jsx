        ...
        {Object.keys(developersData).map((key) => {
          ...
          return (
            <button
              ...
              className="fade-in-right flex justify-center items-center p-4 border-2 border-gray-300 rounded-full overflow-hidden transition-colors duration-300 hover:bg-red-700"
            >
              <img
                src={developer.logo}
                alt={developer.name}
