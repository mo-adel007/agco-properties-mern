...
import ListingResults from "./pages/ListingResultsPage";
import ProjectsResultsPage from "./pages/ProjectsResultsPage";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/projects-results" element={<ProjectsResultsPage />} />
