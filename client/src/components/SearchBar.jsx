...
const SearchBar = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (selectedOption === "New Projects") {
        const projectsResponse = await fetch(`/api/project/search?${query}`, { method: 'GET' });
        ...
        const listingsResponse = await fetch(`/api/listing/search?${query}`, { method: 'GET' });
      ...
      if (selectedOption === "New Projects") {
        navigate("/projects-results", { state: { projects: projectsData } });
      } else {
