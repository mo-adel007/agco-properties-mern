      ...
      <Link to={`/listing/${listing._id}`}>
        ...
        <div className="p-3 flex flex-col gap-2 w-full">
          <p className="truncate text-lg font-semibold text-slate-700">
            {listing.developer} | {listing.community} | {listing.name}
          </p>
        ...
        <div className="flex gap-2">
          ...
          <button className="relative fade-in-bottom font-bold px-4 py-2 sm:px-8 sm:py-2 rounded-3xl  isolation-auto z-10 border-2 border-green-600 before:absolute before:w-full before:transition-all hover:text-white before:duration-700 before:hover:w-full before:-right-full before:hover:right-0 before:rounded-full before:bg-green-600 before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700">
          <i className="fab fa-whatsapp"></i>
            WhatsApp
          </button>
          </a>
          <a href="#" className="  hover:text-white">
          <button className="fade-in-bottom relative font-bold px-4 py-2 sm:px-8 sm:py-2 rounded-3xl   isolation-auto z-10 border-2 border-black before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-right-full before:hover:right-0 before:rounded-full hover:border-red-600 before:bg-black before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700">
